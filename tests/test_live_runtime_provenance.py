...
EXPECTED_EVENT_TYPES = {
    ...
    "RECOVERY_CLAIMED", "RECOVERY_DECISION", "RECOVERY_RESUME_STARTED",
    "RECOVERY_COMPLETED", "RECOVERY_FAILED", "RECOVERY_ACKNOWLEDGED",
    "RECOVERY_CANCELLED", "RECOVERY_TERMINAL_RECONCILED",
}
